...
const MONGODB_URI =
  process.env.MONGODB_URI || "mongodb://localhost:27017/habithunterv2";
...
const buddiesController = require("./controllers/buddiesController.js");
...
app.use("/buddies", buddiesController);
////////////////
